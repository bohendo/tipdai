...
export class TipService {
  ...
  public handleTip = async (sender: User, recipient: User, amount: string, message: string): Promise<string> => {
    try {
      ...
      return `@YYY Success! A tip of $${amount} has been transfered. XXX, you can tip someone else (use the tweet pattern mentioned in my bio) or DM me "balance" to cashout.`;
