...
TIPDAI_APP_ACCESS_SECRET="${TIPDAI_APP_ACCESS_SECRET}"
TIPDAI_APP_USER_ID="${TIPDAI_APP_USER_ID}"
TIPDAI_BOT_ACCESS_SECRET="${TIPDAI_BOT_ACCESS_SECRET}"
TIPDAI_BOT_USER_ID="${TIPDAI_BOT_USER_ID}"
...
services:
  ...
  bot:
    ...
    environment:
      ...
      TWITTER_APP_ACCESS_SECRET: $TIPDAI_APP_ACCESS_SECRET
      TWITTER_APP_ACCESS_TOKEN: $TIPDAI_APP_ACCESS_TOKEN
      TWITTER_BOT_ACCESS_SECRET: $TIPDAI_BOT_ACCESS_SECRET
      TWITTER_BOT_ACCESS_TOKEN: $TIPDAI_BOT_ACCESS_TOKEN
      TWITTER_BOT_USER_ID: $TIPDAI_BOT_USER_ID
